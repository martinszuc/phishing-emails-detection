...
@Database(entities = [EmailMinimal::class, EmailFull::class, EmailBlob::class, EmailMboxMetadata::class, Subject::class, EmailDetection::class], exportSchema = false, version = 3)
